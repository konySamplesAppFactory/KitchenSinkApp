function addWidgetsfrmPlatforms() {
    ...
    var btnAndroidPF = new kony.ui.Button({
        ...
        "id": "btnAndroidPF",
        "isVisible": true,
        "onClick": p2kwiet20606288541905_btnAndroidPF_onClick_seq0,
        "skin": "btnAndPF"
    }, {
        "containerWeight": 22,
    ...
    var btnIOSPF = new kony.ui.Button({
        ...
        "id": "btnIOSPF",
        "isVisible": true,
        "onClick": p2kwiet20606288541905_btnIOSPF_onClick_seq0,
        "skin": "btnIphonePF"
    }, {
        "containerWeight": 22,
        "contentAlignment": constants.CONTENT_ALIGN_CENTER,
    ...
    var btnWinPF = new kony.ui.Button({
        ...
        "id": "btnWinPF",
        "isVisible": true,
        "onClick": p2kwiet20606288541905_btnWinPF_onClick_seq0,
        "skin": "btnWindowsPF"
    }, {
        "containerWeight": 22,
        "contentAlignment": constants.CONTENT_ALIGN_CENTER,
    ...
    var btnBlackberryPF = new kony.ui.Button({
        ...
        "id": "btnBlackberryPF",
        "isVisible": true,
        "onClick": p2kwiet20606288541905_btnBlackberryPF_onClick_seq0,
        "skin": "btnBBPF"
    }, {
        "containerWeight": 22,
        "contentAlignment": constants.CONTENT_ALIGN_CENTER,
    ...
    var btnHTMLPF = new kony.ui.Button({
        ...
        "id": "btnHTMLPF",
        "isVisible": true,
        "onClick": p2kwiet20606288541905_btnHTMLPF_onClick_seq0,
        "skin": "btnHTML5PF"
    }, {
        "containerWeight": 22,
        "contentAlignment": constants.CONTENT_ALIGN_CENTER,
...
function frmPlatformsGlobals() {
    frmPlatforms = new kony.ui.Form2({
        ...
        "id": "frmPlatforms",
        "needAppMenu": false,
        "preShow": p2kwiet20606288541905_frmPlatforms_preshow_seq0,
        "skin": "frm",
        "title": "Home"
    }, {
