function addWidgetsfrmWebSQL() {
    ...
    var btnCreateDB = new kony.ui.Button({
        ...
        "id": "btnCreateDB",
        "isVisible": true,
        "onClick": p2kwiet20606288543322_btnCreateDB_onClick_seq0,
        "skin": "btnNormal",
    ...
    var button1930040990147039 = new kony.ui.Button({
        ...
        "isVisible": true,
        "onClick": p2kwiet20606288543322_button1930040990147039_onClick_seq0,
        "skin": "btnNormal",
        "text": "Insert data"
    }, {
        "containerWeight": 100,
    ...
    var button1930040990147063 = new kony.ui.Button({
        ...
        "isVisible": true,
        "onClick": p2kwiet20606288543322_button1930040990147063_onClick_seq0,
        "skin": "btnNormal",
        "text": "Show data"
    }, {
        "containerWeight": 100,
    ...
    var button1930040990147077 = new kony.ui.Button({
        ...
        "isVisible": true,
        "onClick": p2kwiet20606288543322_button1930040990147077_onClick_seq0,
        "skin": "btnNormal",
        "text": "Update data"
    }, {
        "containerWeight": 100,
    ...
    var button1930040990147091 = new kony.ui.Button({
        ...
        "isVisible": true,
        "onClick": p2kwiet20606288543322_button1930040990147091_onClick_seq0,
        "skin": "btnNormal",
        "text": "Delete data"
    }, {
        "containerWeight": 100,
...
function frmWebSQLGlobals() {
    frmWebSQL = new kony.ui.Form2({
        ...
        "id": "frmWebSQL",
        "needAppMenu": true,
        "preShow": p2kwiet20606288543322_frmWebSQL_preshow_seq0,
        "skin": "frm",
        "title": "WebSQL"
    }, {
